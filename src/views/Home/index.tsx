        ...
        <div className="">
          ...
          <div className="min-h-[400px] [@media(min-width:1281px)]:min-h-[590px] bg-[#1C1919] border border-white rounded-lg px-5 py-10 mb-7">
            <p className="text-5xl font-rhodium-libre mb-1">
              Hi, {user?.given_name}. Time to spark connections with your{" "}
              <Link
                to="/"
                className="text-9xl font-reenie-beanie text-red-700 underline"
              >
                Winbacks.
              </Link>
            </p>
            <div className="grid grid-cols-2 [@media(min-width:1440px)]:grid-cols-4 gap-3 [@media(min-width:1440px)]:gap-6">
              {marketingSite.map(
                ({ icon, title, content, popup, type }, index) => (
                  <div
                    role="button"
                    key={index}
                  ...
                  >
                    <h3 className="text-cyan-900 font-bold ml-5 self-start">
                      {title}
                    </h3>
                    <p
                      className={`font-light text-black -mt-1.5 text-center ${
                        popup ? "text-base" : ""
                      }`}
                    >
                      {content}
              ...
              {isRun ? (
                ...
                <>
                  <li key="-1" className="li-customer-name">
                    <input
                      type="radio"
                      onChange={() => setAllCustomerSelected()}
                      name="customer_name"
                      id={`radio_-1`}
                    />
                    <label htmlFor={`radio_-1`} style={{ cursor: "pointer" }}>
                      All Customers
                    </label>
                  </li>
                    ...
                    return (
                      customer["Customer Name"] && (
                        <li key={index} className="li-customer-name">
                          <input
                            type="radio"
                            onChange={() => setCustomerSelected(customer)}
                            name="customer_name"
                            id={`radio_${index}`}
                          />
                          <label
