   ...
   return (
      <div className="">
         <Link to="/" className="flex justify-center mb-5">
            <img className="w-[120px] md:w-[150px]" src="/images/large-logo.png" alt="" />
         </Link>
        ...
        <img src="/images/Sebo_logo.png" alt="" />
         ...
         <div className="text-center mx-2 mt-[20px] md:mt-[30px]">
            <p className="text-[13px] mb-2 md:mb-3 font-rhodium-libre">You are using the Limited Free Version of BakedBot.</p>
            <p className="text-[13px] mb-0 md:mb-3 font-rhodium-libre">Upgrade and Go Unlimited? Starting at $25/Month</p>
         </div>
